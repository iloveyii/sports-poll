...
## Setup and first run
  ...
  * Point web browser to backend/src/web directory or Create a virtual host using [vh](http://softhem.se/tools/vh) and browse [http://sportspoll.loc](http://sportspoll.loc).
```
